  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        className="w-full rounded border border-gray-300 px-3 py-1.5 text-sm text-gray-800 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
      />
    </div>
  )
}
